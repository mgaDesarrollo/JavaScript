...
var mostrarResultadoActual = function() {
}

var validarSiExisteUnNumero = function() {
	if(numero1 == undefined) {
		numero1 = parseInt(document.getElementById("numero").value);
		resultado = numero1;
	} else {
		numero2 = parseInt(document.getElementById("numero").value);
	}
}
